 ...
 * of this value object you may modify the generated sub-class of this class - SessionFillCreditsBalanceResult_type.as.
 */
...
[ExcludeClass]
public class _Super_SessionFillCreditsBalanceResult_type extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _SessionFillCreditsBalanceResult_typeEntityMetadata;
    ...
    public function _Super_SessionFillCreditsBalanceResult_type()
    {
        _model = new _SessionFillCreditsBalanceResult_typeEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _SessionFillCreditsBalanceResult_typeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _SessionFillCreditsBalanceResult_typeEntityMetadata) : void
    {
        var oldValue : _SessionFillCreditsBalanceResult_typeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
