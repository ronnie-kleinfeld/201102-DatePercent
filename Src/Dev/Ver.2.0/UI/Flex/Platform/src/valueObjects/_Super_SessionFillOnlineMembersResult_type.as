 ...
 * of this value object you may modify the generated sub-class of this class - SessionFillOnlineMembersResult_type.as.
 */
...
[ExcludeClass]
public class _Super_SessionFillOnlineMembersResult_type extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _SessionFillOnlineMembersResult_typeEntityMetadata;
    ...
    public function _Super_SessionFillOnlineMembersResult_type()
    {
        _model = new _SessionFillOnlineMembersResult_typeEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _SessionFillOnlineMembersResult_typeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _SessionFillOnlineMembersResult_typeEntityMetadata) : void
    {
        var oldValue : _SessionFillOnlineMembersResult_typeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
