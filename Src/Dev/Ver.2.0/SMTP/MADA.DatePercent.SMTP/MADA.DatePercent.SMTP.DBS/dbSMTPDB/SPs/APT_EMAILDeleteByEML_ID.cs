...
{
public class procAPT_EMAILDeleteByEML_ID
{
public const string _Name = "APT_EMAILDeleteByEML_ID";
public const string _Caption = "APT_ EMAILDelete By EML_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_EMAILDeleteByEML_ID";
SqlParameterCollection(cmd.Parameters);
return cmd;
}
public static SqlCommand SqlCommand(
System.Nullable<int> p_iEML_ID)
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_EMAILDeleteByEML_ID";
SqlParameterCollection(cmd.Parameters, p_iEML_ID);
return cmd;
}
...
{
p_oSqlParameterCollection.Clear();
p_oSqlParameterCollection.Add(parEML_ID._SqlParameter(p_iEML_ID));
}
public class parEML_ID
{
public const string _Name = "@EML_ID";
public const string _Caption = "@ EML_ ID";
public const string _ParentName = "APT_EMAILDeleteByEML_ID";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_EMAILDeleteByEML_ID.DefaultView.[0].@EML_ID";
...
{
return DBS.Tools.CreateSqlParameterReferenceType("@EML_ID", 10, 0, 4, SqlDbType.Int, "int", ParameterDirection.Input, true, false, "");
}
public static SqlParameter _SqlParameter(System.Nullable<int> Value)
{
return DBS.Tools.CreateSqlParameterReferenceType("@EML_ID", 10, 0, 4, SqlDbType.Int, "int", ParameterDirection.Input, true, false, "", Value);
}
}
public class inEML_ID : parEML_ID {}
...
SqlCommand cmd = SqlCommand(p_iEML_ID);
...
public static int ExecuteNonQuery(
System.Nullable<int> p_iEML_ID,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_iEML_ID);
