...
{
public class procsp_renamediagram
{
public const string _Name = "sp_renamediagram";
public const string _Caption = "sp_renamediagram";
...
public static SqlCommand SqlCommand(
string p_strdiagramname, string p_strnew_diagramname, System.Nullable<int> p_iowner_id)
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "sp_renamediagram";
SqlParameterCollection(cmd.Parameters, p_strdiagramname, p_strnew_diagramname, p_iowner_id);
return cmd;
}
...
p_oSqlParameterCollection.Add(parnew_diagramname._SqlParameter());
...
p_oSqlParameterCollection.Add(parnew_diagramname._SqlParameter(p_strnew_diagramname));
...
public const string _ParentName = "sp_renamediagram";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 128;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "sp_renamediagram.DefaultView.[0].@diagramname";
...
public class parnew_diagramname
{
public const string _Name = "@new_diagramname";
public const string _Caption = "@new_diagramname";
public const string _ParentName = "sp_renamediagram";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 128;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "sp_renamediagram.DefaultView.[0].@new_diagramname";
public const string _BindDataReader = "[@new_diagramname]";
public const ParameterDirection _ParameterDirection = ParameterDirection.Input;
public static SqlParameter _SqlParameter()
{
return DBS.Tools.CreateSqlParameterReferenceType("@new_diagramname", 128, -1, 128, SqlDbType.NVarChar, "string", ParameterDirection.Input, true, false, "");
}
public static SqlParameter _SqlParameter(string Value)
{
return DBS.Tools.CreateSqlParameterReferenceType("@new_diagramname", 128, -1, 128, SqlDbType.NVarChar, "string", ParameterDirection.Input, true, false, "", Value);
}
}
...
public const bool _IsNullable = true;
public const string _BindDataAdapter = "sp_renamediagram.DefaultView.[0].@owner_id";
...
public class innew_diagramname : parnew_diagramname {}
...
SqlCommand cmd = SqlCommand(p_strdiagramname, p_strnew_diagramname, p_iowner_id);
...
public static int ExecuteNonQuery(
string p_strdiagramname, string p_strnew_diagramname, System.Nullable<int> p_iowner_id,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_strdiagramname, p_strnew_diagramname, p_iowner_id);
