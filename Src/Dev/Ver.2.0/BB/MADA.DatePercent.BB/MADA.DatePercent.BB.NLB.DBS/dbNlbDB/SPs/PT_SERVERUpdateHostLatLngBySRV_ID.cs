...
{
public class procPT_SERVERUpdateHostLatLngBySRV_ID
{
public const string _Name = "PT_SERVERUpdateHostLatLngBySRV_ID";
public const string _Caption = "PT_ SERVERUpdate Host Lat Lng By SRV_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_SERVERUpdateHostLatLngBySRV_ID";
SqlParameterCollection(cmd.Parameters);
return cmd;
}
public static SqlCommand SqlCommand(
System.Nullable<decimal> p_decSRV_HOST_LAT, System.Nullable<decimal> p_decSRV_HOST_LNG, System.Nullable<int> p_iSRV_ID)
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_SERVERUpdateHostLatLngBySRV_ID";
SqlParameterCollection(cmd.Parameters, p_decSRV_HOST_LAT, p_decSRV_HOST_LNG, p_iSRV_ID);
return cmd;
}
...
public const string _ParentName = "PT_SERVERUpdateHostLatLngBySRV_ID";
public const SqlDbType _SqlDbType = SqlDbType.Decimal;
public const Int32 _Length = 9;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_SERVERUpdateHostLatLngBySRV_ID.DefaultView.[0].@SRV_HOST_LAT";
...
public const Int32 _Length = 9;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_SERVERUpdateHostLatLngBySRV_ID.DefaultView.[0].@SRV_HOST_LNG";
...
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_SERVERUpdateHostLatLngBySRV_ID.DefaultView.[0].@SRV_ID";
...
SqlCommand cmd = SqlCommand(p_decSRV_HOST_LAT, p_decSRV_HOST_LNG, p_iSRV_ID);
...
public static int ExecuteNonQuery(
System.Nullable<decimal> p_decSRV_HOST_LAT, System.Nullable<decimal> p_decSRV_HOST_LNG, System.Nullable<int> p_iSRV_ID,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_decSRV_HOST_LAT, p_decSRV_HOST_LNG, p_iSRV_ID);
