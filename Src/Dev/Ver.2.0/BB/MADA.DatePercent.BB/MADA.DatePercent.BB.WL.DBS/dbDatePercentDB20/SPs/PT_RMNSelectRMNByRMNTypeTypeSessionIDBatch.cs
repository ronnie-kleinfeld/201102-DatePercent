...
{
public class procPT_RMNSelectRMNByRMNTypeTypeSessionIDBatch
{
public const string _Name = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch";
public const string _Caption = "PT_ RMNSelect RMNBy RMNType Type Session IDBatch";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch";
SqlParameterCollection(cmd.Parameters);
return cmd;
}
public static SqlCommand SqlCommand(
System.Nullable<int> p_iBatchLength, System.Nullable<int> p_iRMT_RTT_TYPE_TYPE, System.Nullable<int> p_iSessionID)
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch";
SqlParameterCollection(cmd.Parameters, p_iBatchLength, p_iRMT_RTT_TYPE_TYPE, p_iSessionID);
return cmd;
}
...
p_oSqlParameterCollection.Add(parRMT_RTT_TYPE_TYPE._SqlParameter());
...
p_oSqlParameterCollection.Add(parRMT_RTT_TYPE_TYPE._SqlParameter(p_iRMT_RTT_TYPE_TYPE));
...
public const string _ParentName = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch.DefaultView.[0].@BatchLength";
...
public class parRMT_RTT_TYPE_TYPE
{
...
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch.DefaultView.[0].@RMT_RTT_TYPE_TYPE";
public const string _BindDataReader = "[@RMT_RTT_TYPE_TYPE]";
public const ParameterDirection _ParameterDirection = ParameterDirection.Input;
public static SqlParameter _SqlParameter()
{
return DBS.Tools.CreateSqlParameterReferenceType("@RMT_RTT_TYPE_TYPE", 10, 0, 4, SqlDbType.Int, "int", ParameterDirection.Input, true, false, "");
}
public static SqlParameter _SqlParameter(System.Nullable<int> Value)
{
return DBS.Tools.CreateSqlParameterReferenceType("@RMT_RTT_TYPE_TYPE", 10, 0, 4, SqlDbType.Int, "int", ParameterDirection.Input, true, false, "", Value);
}
}
...
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch.DefaultView.[0].@SessionID";
...
public class inRMT_RTT_TYPE_TYPE : parRMT_RTT_TYPE_TYPE {}
public class inSessionID : parSessionID {}
public class rsPT_RMNSelectRMNByRMNTypeTypeSessionIDBatch
{
public const string _Name = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch";
public const string _Caption = "PT_ RMNSelect RMNBy RMNType Type Session IDBatch";
public const string _ParentName = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch";
...
public class slcRMT_RTT_TYPE_TYPE
{
public const string _Name = "RMT_RTT_TYPE_TYPE";
public const string _Caption = "RMT_ RTT_ TYPE_ TYPE";
public const string _ParentName = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch";
...
public class rsPT_RMNSelectRMNByRMNTypeTypeSessionIDBatch1
{
public const string _Name = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch1";
public const string _Caption = "PT_ RMNSelect RMNBy RMNType Type Session IDBatch1";
public const string _ParentName = "PT_RMNSelectRMNByRMNTypeTypeSessionIDBatch";
...
public static void LoadDataSet(System.Data.DataSet p_ds, string p_strTableName,System.Nullable<int> p_iBatchLength, System.Nullable<int> p_iRMT_RTT_TYPE_TYPE, System.Nullable<int> p_iSessionID)
{
try
{
Microsoft.Practices.EnterpriseLibrary.Data.Database db = DatabaseFactory.CreateDatabase();
SqlCommand cmd = SqlCommand(p_iBatchLength, p_iRMT_RTT_TYPE_TYPE, p_iSessionID);
...
public static void LoadDataSet(System.Data.DataSet p_ds, string p_strTableName,System.Nullable<int> p_iBatchLength, System.Nullable<int> p_iRMT_RTT_TYPE_TYPE, System.Nullable<int> p_iSessionID,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_iBatchLength, p_iRMT_RTT_TYPE_TYPE, p_iSessionID);
