...
{
public class procPT_RMNMarkAsUnReadByRMN_ID
{
public const string _Name = "PT_RMNMarkAsUnReadByRMN_ID";
public const string _Caption = "PT_ RMNMark As Un Read By RMN_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_RMNMarkAsUnReadByRMN_ID";
...
public const string _ParentName = "PT_RMNMarkAsUnReadByRMN_ID";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_RMNMarkAsUnReadByRMN_ID.DefaultView.[0].@RMN_ID";
