...
{
public class procPT_LISTUpdateResultView
{
public const string _Name = "PT_LISTUpdateResultView";
public const string _Caption = "PT_ LISTUpdate Result View";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_LISTUpdateResultView";
SqlParameterCollection(cmd.Parameters);
return cmd;
}
public static SqlCommand SqlCommand(
System.Nullable<int> p_iLST_ID, System.Nullable<int> p_iLST_RESULT_VIEW_TYPE_CODE)
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_LISTUpdateResultView";
SqlParameterCollection(cmd.Parameters, p_iLST_ID, p_iLST_RESULT_VIEW_TYPE_CODE);
return cmd;
}
...
public const string _ParentName = "PT_LISTUpdateResultView";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_LISTUpdateResultView.DefaultView.[0].@LST_ID";
...
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_LISTUpdateResultView.DefaultView.[0].@LST_RESULT_VIEW_TYPE_CODE";
...
SqlCommand cmd = SqlCommand(p_iLST_ID, p_iLST_RESULT_VIEW_TYPE_CODE);
...
public static int ExecuteNonQuery(
System.Nullable<int> p_iLST_ID, System.Nullable<int> p_iLST_RESULT_VIEW_TYPE_CODE,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_iLST_ID, p_iLST_RESULT_VIEW_TYPE_CODE);
