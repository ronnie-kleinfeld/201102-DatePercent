...
{
public class procAPT_USER_SETTINGDeleteByUSS_USER_IDUSS_USER_SETTING_TYPE
{
public const string _Name = "APT_USER_SETTINGDeleteByUSS_USER_IDUSS_USER_SETTING_TYPE";
public const string _Caption = "APT_ USER_ SETTINGDelete By USS_ USER_ IDUSS_ USER_ SETTING_ TYPE";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_USER_SETTINGDeleteByUSS_USER_IDUSS_USER_SETTING_TYPE";
...
public const string _ParentName = "APT_USER_SETTINGDeleteByUSS_USER_IDUSS_USER_SETTING_TYPE";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_SETTINGDeleteByUSS_USER_IDUSS_USER_SETTING_TYPE.DefaultView.[0].@USS_USER_ID";
...
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_SETTINGDeleteByUSS_USER_IDUSS_USER_SETTING_TYPE.DefaultView.[0].@USS_USER_SETTING_TYPE";
...
public static int ExecuteNonQuery(
System.Nullable<int> p_iUSS_USER_ID, System.Nullable<int> p_iUSS_USER_SETTING_TYPE,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_iUSS_USER_ID, p_iUSS_USER_SETTING_TYPE);
