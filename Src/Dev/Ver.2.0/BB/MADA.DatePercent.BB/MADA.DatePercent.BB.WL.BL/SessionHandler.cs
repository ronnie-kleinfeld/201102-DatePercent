...
namespace MADA.DatePercent.BB.WL.BL
{
    public partial class SessionHandler
    {
        ...
        public string UserInit(int p_iSessionID, Database p_db, DbTransaction p_trn)
        {
            ...
            {
                Logger.Instance.Write(ex, MethodBase.GetCurrentMethod(), LoggerSessionID);
        ...
        public int UserInsertIntoUpdate(FacebookDataSet.T_USER_FACEBOOKRow p_drFbFqlUser, Database p_db, DbTransaction p_trn)
        {
            try
            {
                ...
                Logger.Instance.WriteProcess("New USR_ID:" + iUSR_ID, MethodBase.GetCurrentMethod(), LoggerSessionID);

                Logger.Instance.WriteProcess("Success", MethodBase.GetCurrentMethod(), LoggerSessionID);
        ...
        public string DeleteMember(int p_iSessionID)
        {
            try
            {
                ...
                Logger.Instance.WriteCritical("Member deleted:" + p_iSessionID, MethodBase.GetCurrentMethod(), LoggerSessionID);
                return ResultCode.SUCCESS;
            }
            catch (Exception ex)
            {
        ...
        public int EMailInsertIntoUpdate(int p_iSessionID, string p_strEMail, Database p_db, DbTransaction p_trn)
        {
            try
            {
                ...
                Logger.Instance.WriteProcess("Success:" + oUSE_ID.ToString(), MethodBase.GetCurrentMethod(), LoggerSessionID);
        ...
        public string SessionDoLogin(string p_strSID, int p_iUserID, Database p_db, DbTransaction p_trn)
        {
            try
            {
                ...
                {
                    Logger.Instance.WriteProcess("Session Exists", MethodBase.GetCurrentMethod(), p_strSID);
                    return ResultCode.SUCCESS;
                }
                else
                {
                    ...
                    {
                        Logger.Instance.WriteProcess("New Session", MethodBase.GetCurrentMethod(), p_strSID);
                        return ResultCode.SUCCESS;
                    }
                }
            }
