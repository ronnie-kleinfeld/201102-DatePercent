...
{
public class procPT_USERUpdateUSR_DONT_ASK_PROFILE_UPDATEDByUSL_SID
{
public const string _Name = "PT_USERUpdateUSR_DONT_ASK_PROFILE_UPDATEDByUSL_SID";
public const string _Caption = "PT_ USERUpdate USR_ DONT_ ASK_ PROFILE_ UPDATEDBy USL_ SID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_USERUpdateUSR_DONT_ASK_PROFILE_UPDATEDByUSL_SID";
...
public const string _ParentName = "PT_USERUpdateUSR_DONT_ASK_PROFILE_UPDATEDByUSL_SID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 50;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_USERUpdateUSR_DONT_ASK_PROFILE_UPDATEDByUSL_SID.DefaultView.[0].@USL_SID";
