...
{
public class procAPT_USERSelectByUSR_FB_UID
{
public const string _Name = "APT_USERSelectByUSR_FB_UID";
public const string _Caption = "APT_ USERSelect By USR_ FB_ UID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_USERSelectByUSR_FB_UID";
SqlParameterCollection(cmd.Parameters);
return cmd;
}
public static SqlCommand SqlCommand(
string p_strUSR_FB_UID)
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_USERSelectByUSR_FB_UID";
SqlParameterCollection(cmd.Parameters, p_strUSR_FB_UID);
return cmd;
}
...
public const string _ParentName = "APT_USERSelectByUSR_FB_UID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 255;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USERSelectByUSR_FB_UID.DefaultView.[0].@USR_FB_UID";
...
public class rsAPT_USERSelectByUSR_FB_UID
{
public const string _Name = "APT_USERSelectByUSR_FB_UID";
public const string _Caption = "APT_ USERSelect By USR_ FB_ UID";
public const string _ParentName = "APT_USERSelectByUSR_FB_UID";
...
public static void LoadDataSet(System.Data.DataSet p_ds, string p_strTableName,string p_strUSR_FB_UID)
{
try
{
Microsoft.Practices.EnterpriseLibrary.Data.Database db = DatabaseFactory.CreateDatabase();
SqlCommand cmd = SqlCommand(p_strUSR_FB_UID);
...
public static void LoadDataSet(System.Data.DataSet p_ds, string p_strTableName,string p_strUSR_FB_UID,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_strUSR_FB_UID);
