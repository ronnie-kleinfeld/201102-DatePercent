...
{
public class procPT_USER_INBOXDeleteByUSL_SID_USI_SENDER_USER_ID
{
public const string _Name = "PT_USER_INBOXDeleteByUSL_SID_USI_SENDER_USER_ID";
public const string _Caption = "PT_ USER_ INBOXDelete By USL_ SID_ USI_ SENDER_ USER_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_USER_INBOXDeleteByUSL_SID_USI_SENDER_USER_ID";
SqlParameterCollection(cmd.Parameters);
return cmd;
}
public static SqlCommand SqlCommand(
System.Nullable<int> p_iUSI_SENDER_USER_ID, string p_strUSL_SID)
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_USER_INBOXDeleteByUSL_SID_USI_SENDER_USER_ID";
SqlParameterCollection(cmd.Parameters, p_iUSI_SENDER_USER_ID, p_strUSL_SID);
return cmd;
}
...
public const string _ParentName = "PT_USER_INBOXDeleteByUSL_SID_USI_SENDER_USER_ID";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_USER_INBOXDeleteByUSL_SID_USI_SENDER_USER_ID.DefaultView.[0].@USI_SENDER_USER_ID";
...
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_USER_INBOXDeleteByUSL_SID_USI_SENDER_USER_ID.DefaultView.[0].@USL_SID";
...
SqlCommand cmd = SqlCommand(p_iUSI_SENDER_USER_ID, p_strUSL_SID);
...
public static int ExecuteNonQuery(
System.Nullable<int> p_iUSI_SENDER_USER_ID, string p_strUSL_SID,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_iUSI_SENDER_USER_ID, p_strUSL_SID);
