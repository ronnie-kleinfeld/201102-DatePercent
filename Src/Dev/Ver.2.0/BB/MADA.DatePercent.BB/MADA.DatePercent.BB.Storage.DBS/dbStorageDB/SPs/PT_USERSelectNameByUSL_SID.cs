...
{
public class procPT_USERSelectNameByUSL_SID
{
public const string _Name = "PT_USERSelectNameByUSL_SID";
public const string _Caption = "PT_ USERSelect Name By USL_ SID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_USERSelectNameByUSL_SID";
...
public const string _ParentName = "PT_USERSelectNameByUSL_SID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 50;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_USERSelectNameByUSL_SID.DefaultView.[0].@USL_SID";
...
public class rsPT_USERSelectNameByUSL_SID
{
public const string _Name = "PT_USERSelectNameByUSL_SID";
public const string _Caption = "PT_ USERSelect Name By USL_ SID";
public const string _ParentName = "PT_USERSelectNameByUSL_SID";
public class slcFullName
{
public const string _Name = "FullName";
public const string _Caption = "Full Name";
public const string _ParentName = "PT_USERSelectNameByUSL_SID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 101;
}
}
