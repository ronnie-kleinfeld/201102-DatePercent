...
{
public class procPT_USERUpdateUSR_RADIUS_KMByUSL_SID
{
public const string _Name = "PT_USERUpdateUSR_RADIUS_KMByUSL_SID";
public const string _Caption = "PT_ USERUpdate USR_ RADIUS_ KMBy USL_ SID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_USERUpdateUSR_RADIUS_KMByUSL_SID";
SqlParameterCollection(cmd.Parameters);
return cmd;
}
public static SqlCommand SqlCommand(
string p_strUSL_SID, System.Nullable<int> p_iUSR_RADIUS_KM)
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_USERUpdateUSR_RADIUS_KMByUSL_SID";
SqlParameterCollection(cmd.Parameters, p_strUSL_SID, p_iUSR_RADIUS_KM);
return cmd;
}
...
public const string _ParentName = "PT_USERUpdateUSR_RADIUS_KMByUSL_SID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 50;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_USERUpdateUSR_RADIUS_KMByUSL_SID.DefaultView.[0].@USL_SID";
...
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_USERUpdateUSR_RADIUS_KMByUSL_SID.DefaultView.[0].@USR_RADIUS_KM";
...
SqlCommand cmd = SqlCommand(p_strUSL_SID, p_iUSR_RADIUS_KM);
...
public static int ExecuteNonQuery(
string p_strUSL_SID, System.Nullable<int> p_iUSR_RADIUS_KM,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_strUSL_SID, p_iUSR_RADIUS_KM);
