...
{
public class procPT_USER_COMMUpdateAsReadByUSL_SID
{
public const string _Name = "PT_USER_COMMUpdateAsReadByUSL_SID";
public const string _Caption = "PT_ USER_ COMMUpdate As Read By USL_ SID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_USER_COMMUpdateAsReadByUSL_SID";
...
public const string _ParentName = "PT_USER_COMMUpdateAsReadByUSL_SID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 50;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_USER_COMMUpdateAsReadByUSL_SID.DefaultView.[0].@USL_SID";
