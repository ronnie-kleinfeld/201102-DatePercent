...
{
public class tblT_USER_LINK_TYPE_ENUM
{
public const string _Name = "T_USER_LINK_TYPE_ENUM";
public const string _Caption = "T_ USER_ LINK_ TYPE_ ENUM";
...
public const string _ParentName = "T_USER_LINK_TYPE_ENUM";
...
public const string _BindDataAdapter = "T_USER_LINK_TYPE_ENUM.DefaultView.[0].UST_CODE";
...
public const string _BindDataAdapter = "T_USER_LINK_TYPE_ENUM.DefaultView.[0].UST_DESCRIPTION";
...
public const bool _IsPrimaryKey = false;
public const string _BindDataAdapter = "T_USER_LINK_TYPE_ENUM.DefaultView.[0].ValueCode";
...
public const bool _IsComputed = true;
public const bool _IsPrimaryKey = false;
public const string _BindDataAdapter = "T_USER_LINK_TYPE_ENUM.DefaultView.[0].ValueName";
...
public const bool _IsComputed = true;
public const bool _IsPrimaryKey = false;
public const string _BindDataAdapter = "T_USER_LINK_TYPE_ENUM.DefaultView.[0].ValueNameEnum";
public const string _BindDataReader = "[ValueNameEnum]";
}
public class idxPK_T_USER_LINK_TYPE_ENUM
{
public const string _Name = "PK_T_USER_LINK_TYPE_ENUM";
public const string _Caption = "PK_ T_ USER_ LINK_ TYPE_ ENUM";
public const string _ParentName = "T_USER_LINK_TYPE_ENUM";
public const bool _IsPrimaryKey = true;

public class ixcUST_CODE : colUST_CODE {}
}
public class pkxPK_T_USER_LINK_TYPE_ENUM : idxPK_T_USER_LINK_TYPE_ENUM {}
}
}
