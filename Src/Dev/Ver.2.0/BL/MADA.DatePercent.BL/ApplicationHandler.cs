    ...
    partial class ApplicationHandler
    {
        ...
        public void Refresh()
        {
            ...
            try
            {
                ...
                foreach (DataTable dt in this.Tables)
                {
                    ...
                    Logger.Instance.WriteInformation("Table " + dt.TableName + "loaded", System.Reflection.MethodBase.GetCurrentMethod(), Environment.MachineName);
                }
            ...
            {
                Logger.Instance.WriteCritical("ApplicationHandler Table loadeing failed at table:" + strTableName + ". " + ex.Message, System.Reflection.MethodBase.GetCurrentMethod(), Environment.MachineName);
            }
        }
        public void RefershT_DOMAIN_TYPE_ENUM()
        {
            try
            {
                ...
                Logger.Instance.WriteInformation("RefershT_DOMAIN_TYPE_ENUM", System.Reflection.MethodBase.GetCurrentMethod(), Environment.MachineName);
            }
            catch (System.Exception ex)
            {
                Logger.Instance.Write(ex, System.Reflection.MethodBase.GetCurrentMethod(), Environment.MachineName);
        ...
        public DatePercent_T_USERRow DatePercentUser
        {
            get
            {
                ...
                {
                    Logger.Instance.WriteCritical("RONNIE: Ronnie's UID (EFCCA098-D661-4CD5-99EF-E9AAD2591318) is missing in the database.", System.Reflection.MethodBase.GetCurrentMethod(), Environment.MachineName);
