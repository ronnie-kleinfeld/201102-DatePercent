...
namespace MADA.DatePercent.BL
{
    public class FacebookUtil
    {
        public static string InsertIntoUpdate(string p_strSID, FacebookDataSet.T_USER_FACEBOOKRow p_drFbFqlUser, int p_iUSR_ID, Database p_db, DbTransaction p_trn)
        {
            try
            {
                ...
                procAPT_USER_FACEBOOKInsertIntoUpdateByUSF_FB_UID.ExecuteNonQuery(
                    ...
                    out oUSF_ID,
                    p_db, p_trn);
                Logger.Instance.WriteProcess("Success", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
        ...
        public static FacebookDataSet.T_USER_FACEBOOKRow GetFbDbUser(string p_strFBUID, Database p_db, DbTransaction p_trn)
        {
            try
            {
                Logger.Instance.WriteProcess("p_strFBUID:" + p_strFBUID, System.Reflection.MethodBase.GetCurrentMethod(), p_strFBUID);
                ...
                {
                    Logger.Instance.Write(ds.T_USER_FACEBOOK[0], System.Reflection.MethodBase.GetCurrentMethod(), p_strFBUID);
            ...
            {
                Logger.Instance.Write(ex, System.Reflection.MethodBase.GetCurrentMethod(), p_strFBUID);
                return null;
            }
        }
        ...
        public static FacebookDataSet.T_USER_FACEBOOKRow GetFbFqlUser(string p_strSID, string p_strToken)
        {
            try
            {
                Logger.Instance.WriteProcess("GetFbFqlUser Started", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteProcess("p_strToken:" + p_strToken, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);

                FacebookDataSet ds = new FacebookDataSet();

                Logger.Instance.WriteProcess("Get FqlUser", System.Reflection.MethodBase.GetCurrentMethod(), string.Empty);
                ...
                Logger.Instance.Write(dsTemp, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                DataRow drFqlUser;
                try
                {
                ...
                Logger.Instance.Write(drFqlUser, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);

                Logger.Instance.WriteProcess("Transform data", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                ...
                {
                    Logger.Instance.Write(ex, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                    Logger.Instance.WriteCritical("birthday_date:" + drFqlUser["birthday_date"].ToString(), System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                    dtFqlBirthday = new DateTime(1990, 6, 15);
                }
                Logger.Instance.WriteInformation("dtFqlBirthday:" + dtFqlBirthday.ToString(), System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                ...
                Logger.Instance.WriteInformation("iFqlSex:" + iFqlSex, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);

                Logger.Instance.WriteProcess("Convert to T_USER_FACEBOOK", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                ...
                Logger.Instance.WriteProcess("T_USER_FACEBOOK Converted", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                FacebookDataSet.T_USER_FACEBOOKRow drFacebookUser = ds.T_USER_FACEBOOK[0];
                Logger.Instance.WriteProcess("drFacebookUser:" + drFacebookUser.USF_FB_UID, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                if (drFacebookUser == null)
                {
                    throw new Exception("Failed to convert to T_USER_FACEBOOKRow");
                }
                Logger.Instance.Write(drFacebookUser, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);

                Logger.Instance.WriteProcess("GetFbFqlUser Return", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
            ...
            {
                Logger.Instance.WriteProcess("GetFbFqlUser Ended", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
            }
        }
        public static FacebookDataSet.T_USER_PHOTODataTable GetFbFqlPhotos(string p_strSID, string p_strToken)
        {
            try
            {
                ...
                Logger.Instance.WriteProcess("Get FqlPhotos", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                DataSet dsTemp = new DataSet();
                ...
                Logger.Instance.WriteProcess("Photo count:" + dsTemp.Tables["photo"].Rows.Count, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                foreach (DataRow dr in dsTemp.Tables["photo"].Rows)
                {
                    Logger.Instance.Write(dr, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
        ...
        public static String RSVPEvent(string p_strSID, string p_strEventID, string p_strToken)
        {
            try
            {
                Logger.Instance.WriteProcess("RSVPEvent", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                DataSet dsTemp = new DataSet();
        ...
        public static DataSet GetFriends(string p_strSID, string p_strToken)
        {
            try
            {
                Logger.Instance.WriteProcess("GetFriends", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                DataSet dsTemp = new DataSet();
                ...
                Logger.Instance.WriteProcess("Friends count:" + dsTemp.Tables["friends_get_response"].Rows.Count, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
        ...
        private static XmlDocument GetFbGraphApi(string p_strSID, string p_strGraphApiUri)
        {
            ...
            try
            {
                ...
                {
                    Logger.Instance.WriteCritical("Failed to validate the access token for SID:" + p_strSID, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                    return null;
                }
                else
                {
