<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RedirerctToShareOnFacebook.aspx.cs"
    Inherits="MADA.DatePercent.WL.Public.RedirerctToShareOnFacebook" %>
                        ...
                        <tbody>
                            <tr>
                                <td style='padding: 10px 8px; background-color: rgb(59, 89, 152);' valign='top' width='100%'>
                                    <a style='color: rgb(255, 255, 255); font-family: verdana, arial, sans-serif; font-size: 22px;
                                    ...
                                    <a style='color: rgb(255, 255, 255); font-family: verdana, arial, sans-serif; font-size: 22px;
                                        font-weight: bold; text-decoration: none' target='_blank'>DatePercent - GMail</a><br />
                                    <br />
                                                ...
                                                <td style='padding: 0px 12px; color: rgb(0, 0, 0); font-family: Verdana, Arial, Helvetica, sans-serif;
                                                    ...
                                                    <div style='clear: both; float: none;'>
                                                        ...
                                                        <h2 style='margin: 0px 0px 0px 0px; padding: 0px; color: rgb(59, 89, 152); font-size: 14px;'>
                                                            Please wait while DatePercent redirects...
                                                        </h2>
                                                        <br clear='all' />
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td style='padding: 8px 8px 0px; font-family: verdana, arial, sans-serif; font-size: 11px;'
                                                    ...
                                                    <p style='color: rgb(255, 255, 255);'>
                                                        © Copyright 2011 <a style='color: rgb(255, 255, 255);' target='_blank'>DatePercent</a>.
