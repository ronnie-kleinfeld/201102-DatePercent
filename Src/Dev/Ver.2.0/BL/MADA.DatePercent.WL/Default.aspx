<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs" Inherits="MADA.DatePercent.WL._Default" %>
...
<script type="text/javascript">
    function Redirect()
    {
        window.location = "RedirectToApp.htm" + window.location.search;
    }
</script>
                ...
                <tbody>
                    <tr>
                        <td style='padding: 10px 8px; background-color: rgb(59, 89, 152);' valign='top' width='100%'>
                            ...
                            <a style='color: rgb(255, 255, 255); font-family: verdana, arial, sans-serif; font-size: 22px;
                                font-weight: bold; text-decoration: none' target='_blank'>DatePercent</a><br />
                            <br />
