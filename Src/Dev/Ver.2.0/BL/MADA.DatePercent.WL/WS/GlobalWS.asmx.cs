...
namespace MADA.DatePercent.WL.WS
{
    /// <summary>
    /// Summary description for GlobalWS
    /// </summary>
    ...
    public class GlobalWS : System.Web.Services.WebService
    {
        ...
        public FS GFS(string p_strSID)
        {
            ...
            try
            {
                ...
                procPT_LOGONSelectRMNByLGN_USER_ID.LoadDataSet(ds, MADA.DatePercent.BE.Constants.LOAD_DATASET_TABLE_NAME, iSessionID);
                ...
                if (ApplicationHandler.Instance.m_dsFlexApplication == null)
                {
                    ...
                    foreach (DataTable dt in ApplicationHandler.Instance.Tables)
                    {
                        ...
                        switch (dt.TableName)
                        {
                            ...
                            case "T_PROP_AGE_RANGE_TYPE":
                            case "T_PROP_BODY_STYLE_TYPE":
                            case "T_PROP_CUSTODY_TYPE":
                            case "T_PROP_DRINK_TYPE":
                            case "T_PROP_EYE_TYPE":
                            case "T_PROP_HAIR_TYPE":
                            case "T_PROP_HAVE_KIDS_TYPE":
                            case "T_PROP_HEIGHT_TYPE":
                            case "T_PROP_LANGUAGE_TYPE":
                            case "T_PROP_LOCATION_VISIBILITY_TYPE":
                            case "T_PROP_MATCH_SEX_TYPE":
                            case "T_PROP_RELATIONSHIP_TYPE":
                            case "T_PROP_SEX_TYPE_ENUM":
                            case "T_PROP_SMOKE_TYPE":
                            case "T_PROP_STATUS_TYPE":
                            case "T_PROP_WANT_KIDS_TYPE":
                            case "T_PROP_WEIGHT_TYPE":
                            case "T_PROP_ZODIAC_SIGN_TYPE":
                            case "T_PROP_EDUCATION_TYPE":
                            case "T_PROP_INTERESTS_TYPE":
                            case "T_PROP_OCCUPATION_TYPE":
                            case "T_PROP_RACE_TYPE":
                            case "T_PROP_RELIGION_TYPE":
        ...
        public DataSet FrameworkGetSession(string p_strSID, string p_strDetailsID)
        {
            try
            {
                ...
                Logger.Instance.WriteProcess("Got session:" + iSessionID, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.Write(sessionHandler, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
            ...
            object p_oLanguage, object p_oInterests, object p_oRelationship)
        {
            try
            {
                ...
                using (DbConnection con = db.CreateConnection())
                {
                    ...
                    {
                        trn.Rollback();
                        Logger.Instance.WriteRollbackTrn(ex, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
        ...
        public string ShareAddEmailCredentials(string p_strSID, string p_strCreditPointsEmail, string p_strCreditPointsPassword)
        {
            try
            {
                ...
                Logger.Instance.WriteInformation("strSecretKey:" + strSecretKey, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
        ...
        public DataSet GetSetting(string p_strSID)
        {
            try
            {
                ...
                Logger.Instance.WriteProcess("Got settings:" + iSessionID, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                ...
                using (DbConnection con = db.CreateConnection())
                {
                    ...
                    try
                    {
                        ...
                        if (bSetDetailsLinkType)
                        {
                            ...
                            {
                                object oULK_ID;
                                DBS.dbDatePercentDB.SPs.procAPT_USER_LINKInsertInto.ExecuteNonQuery(
        ...
        public DataSet GetTwinks(string p_strSID)
        {
            ...
            {
                DataSet ds = new DataSet();
                DBS.dbDatePercentDB.SPs.procPT_TWINK_TYPESelect.LoadDataSet(ds, "T_TWINK_TYPE");
                DBS.dbDatePercentDB.SPs.procPT_TWINKSelect.LoadDataSet(ds, "T_TWINK");
                return Serializer.SerializeToFlex(ds);
            }
            catch (System.Exception ex)
            {
        ...
        public string Delete(string p_strSID, int p_iRMN_ID)
        {
            try
            {
                DBS.dbDatePercentDB.SPs.procAPT_RMNDeleteByRMN_ID.ExecuteNonQuery(p_iRMN_ID);
                return BE.ResultCode.SUCCESS;
            }
            catch (System.Exception ex)
            {
        ...
        private string MarkAsReadUnRead(string p_strSID, Boolean p_bRead, int p_iRMN_ID)
        {
            try
            {
                if (p_bRead)
                {
                    DBS.dbDatePercentDB.SPs.procPT_RMNMarkAsReadByRMN_ID.ExecuteNonQuery(p_iRMN_ID);
                    Logger.Instance.WriteInformation("RMN_ID " + p_iRMN_ID + " marked as read.", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                }
                else
                {
                    DBS.dbDatePercentDB.SPs.procPT_RMNMarkAsUnReadByRMN_ID.ExecuteNonQuery(p_iRMN_ID);
                    Logger.Instance.WriteInformation("RMN_ID " + p_iRMN_ID + " marked as un read.", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                }
                return BE.ResultCode.SUCCESS;
            }
            catch (System.Exception ex)
            ...
            bool p_bGetUnlinked, string p_strLink)
        {
            try
            {
                Logger.Instance.WriteInformation("SMapSearch begin:" + p_strSID, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_strSID:" + p_strSID, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_iBatchLength:" + p_iBatchLength, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_strText:" + p_strText, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("m_bDoProximitySearch:" + m_bDoProximitySearch, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_decVisibleWest:" + p_decVisibleWest, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_decVisibleEast:" + p_decVisibleEast, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_decVisibleNorth:" + p_decVisibleNorth, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_decVisibleSouth:" + p_decVisibleSouth, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_decNull:" + p_decNull, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_bLogon:" + p_bLogon, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_dtNow:" + p_dtNow, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_decAgeFrom:" + p_decAgeFrom, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_decAgeTo:" + p_decAgeTo, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_strSex:" + p_strSex, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                Logger.Instance.WriteInformation("p_strStatus:" + p_strStatus, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                ...
                if (m_bDoProximitySearch)
                {
                    ...
                    else if (p_decVisibleWest < 0)
                    {
                        ...
                        {
                            Logger.Instance.WriteCritical("p_decVisibleEast out of bounds:" + p_decVisibleEast, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                        }
                    }
                    else if (p_decVisibleWest >= 0)
                    {
                ...
                using (DbConnection con = db.CreateConnection())
                {
                    ...
                    try
                    {
                        ...
                        Logger.Instance.WriteInformation("CommandText:" + cmd.CommandText, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                ...
                //Logger.Instance.Write(ds, System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
        ...
        public DataSet GetFAQs(string p_strSID)
        {
            ...
            {
                DataSet ds = new DataSet();
                DBS.dbDatePercentDB.SPs.procPT_FAQ_TYPESelect.LoadDataSet(ds, "T_FAQ_TYPE");
                DBS.dbDatePercentDB.SPs.procAPT_FAQSelect.LoadDataSet(ds, "T_FAQ");
                return Serializer.SerializeToFlex(ds);
            }
            catch (System.Exception ex)
            {
        ...
        public DataSet SupportGetTickets(string p_strSID)
        {
            try
            {
                ...
                Logger.Instance.WriteInformation("ronnie", System.Reflection.MethodBase.GetCurrentMethod(), p_strSID);
                DataSet ds = new DataSet();
        ...
        public string Ping()
        {
            try
            {
                Logger.Instance.WriteProcess("Ping", System.Reflection.MethodBase.GetCurrentMethod(), "Ping");
                return ResultCode.SUCCESS;
            }
            catch (Exception ex)
            {
