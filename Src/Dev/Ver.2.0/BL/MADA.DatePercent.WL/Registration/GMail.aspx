<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GMail.aspx.cs" Inherits="MADA.DatePercent.WL.Registration.GMail" %>
...
<script language="javascript">
    ...
    if (strHref.indexOf("#access_token=") != -1)
    {
        window.location = strHref.replace("#access_token=", "?access_token=");
    }
</script>
                    ...
                    <tbody>
                        <tr>
                            <td style='padding: 10px 8px; background-color: rgb(59, 89, 152);' valign='top' width='100%'>
                                ...
                                <a href='<%= MADA.DatePercent.BE.Constants.UIRedirectToAppUrl %>' style='color: rgb(255, 255, 255);
                                    font-family: verdana, arial, sans-serif; font-size: 22px; font-weight: bold;
                                    text-decoration: none' target='_blank'>DatePercent - GMail</a><br />
                                <br />
                                            ...
                                            <td style='padding: 0px 12px; color: rgb(0, 0, 0); font-family: Verdana, Arial, Helvetica, sans-serif;
                                                ...
                                                <div style='clear: both; float: none;'>
                                                    ...
                                                    <h2 style='margin: 0px 0px 0px 0px; padding: 0px; color: rgb(59, 89, 152); font-size: 14px;'>
                                                        Thanks for sharing DatePercent with your friends.<br />
                                                        You may now close this window and return to DatePercent.
                                                    </h2>
                                                    <br clear='all' />
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td style='padding: 8px 8px 0px; font-family: verdana, arial, sans-serif; font-size: 11px;'
                                                ...
                                                <p style='color: rgb(255, 255, 255);'>
                                                    © Copyright 2011 <a href='<%= MADA.DatePercent.BE.Constants.UIRedirectToAppUrl %>'
                                                        style='color: rgb(255, 255, 255);' target='_blank'>DatePercent</a>. All rights
                                                    reserved.</p>
                                            </td>
                                        </tr>
                                    </tbody>
