<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Unsubscribe.aspx.cs" Inherits="MADA.DatePercent.WL.Registration.Unsubscribe" %>
                    ...
                    <tbody>
                        <tr>
                            <td style='padding: 10px 8px; background-color: rgb(59, 89, 152);' valign='top' width='100%'>
                                ...
                                <a href='<%=MADA.DatePercent.BE.Constants.UIRedirectToAppUrl%>' style='color: rgb(255, 255, 255);
                                    font-family: verdana, arial, sans-serif; font-size: 22px; font-weight: bold;
                                    text-decoration: none' target='_blank'>DatePercent - Unsubscribe </a>
                                <br />
                                <br />
                                        ...
                                        <tr>
                                            <td style='padding: 0px 12px; color: rgb(0, 0, 0); font-family: Verdana, Arial, Helvetica, sans-serif;
                                                ...
                                                <div style='clear: both; float: none;'>
                                                    <br />
                                                    <a href='<%=MADA.DatePercent.BE.Constants.UIRedirectToAppUrl%>' target='_blank'>
                                                        <img style='margin: 0px 10px 0px 0px; padding: 0px; border: 0px currentColor; float: left;
                                                            width: 133px; height: 100px;' border='0' hspace='2' vspace='2' align='left' src='<%= m_strUsrFbPic%>' />
                                                    </a>
                                                    <h2 style='margin: 0px 0px 0px 0px; padding: 0px; color: rgb(59, 89, 152); font-size: 14px;'>
                                                        You requested to unsubscribe '<%= m_strEMail%>' from DatePercent<br />
                                                    </h2>
                                                    <br clear='all' />
                                                    <p style='margin: 10px 0px 0px; color: rgb(59, 89, 152); font-size: 13px; font-weight: bolder;
                                                        text-align: right;'>
                                                        <asp:Button ID="buttonUnsubscribe" runat="server" Text="Unsubscribe" OnClick="buttonUnsubscribe_Click" />
