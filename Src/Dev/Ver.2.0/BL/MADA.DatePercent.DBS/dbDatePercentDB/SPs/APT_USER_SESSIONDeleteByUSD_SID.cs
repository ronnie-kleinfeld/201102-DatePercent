...
{
public class procAPT_USER_SESSIONDeleteByUSD_SID
{
public const string _Name = "APT_USER_SESSIONDeleteByUSD_SID";
public const string _Caption = "APT_ USER_ SESSIONDelete By USD_ SID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_USER_SESSIONDeleteByUSD_SID";
...
public const string _ParentName = "APT_USER_SESSIONDeleteByUSD_SID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 50;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_SESSIONDeleteByUSD_SID.DefaultView.[0].@USD_SID";
...
public static int ExecuteNonQuery(
string p_strUSD_SID,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_strUSD_SID);
