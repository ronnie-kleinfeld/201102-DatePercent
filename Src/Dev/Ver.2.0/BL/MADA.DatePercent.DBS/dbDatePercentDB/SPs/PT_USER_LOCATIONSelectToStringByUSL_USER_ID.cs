...
//
//     generation time: 28/08/2011 21:12
// </autogenerated>
//------------------------------------------------------------------------------
using System;
using System.Data;
...
{
public class procPT_USER_LOCATIONSelectToStringByUSL_USER_ID
{
public const string _Name = "PT_USER_LOCATIONSelectToStringByUSL_USER_ID";
public const string _Caption = "PT_ USER_ LOCATIONSelect To String By USL_ USER_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "PT_USER_LOCATIONSelectToStringByUSL_USER_ID";
...
public const string _ParentName = "PT_USER_LOCATIONSelectToStringByUSL_USER_ID";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "PT_USER_LOCATIONSelectToStringByUSL_USER_ID.DefaultView.[0].@USL_USER_ID";
...
public class rsPT_USER_LOCATIONSelectToStringByUSL_USER_ID
{
public const string _Name = "PT_USER_LOCATIONSelectToStringByUSL_USER_ID";
public const string _Caption = "PT_ USER_ LOCATIONSelect To String By USL_ USER_ ID";
public const string _ParentName = "PT_USER_LOCATIONSelectToStringByUSL_USER_ID";
public class slcCRY_ALPHA_3_CODE
{
public const string _Name = "CRY_ALPHA_3_CODE";
public const string _Caption = "CRY_ ALPHA_3_ CODE";
public const string _ParentName = "PT_USER_LOCATIONSelectToStringByUSL_USER_ID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 50;
}
public class slcCTY_DESCRIPTION
{
public const string _Name = "CTY_DESCRIPTION";
public const string _Caption = "CTY_ DESCRIPTION";
public const string _ParentName = "PT_USER_LOCATIONSelectToStringByUSL_USER_ID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 50;
}
public class slcRGN_DESCRIPTION
{
public const string _Name = "RGN_DESCRIPTION";
public const string _Caption = "RGN_ DESCRIPTION";
public const string _ParentName = "PT_USER_LOCATIONSelectToStringByUSL_USER_ID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 50;
}
