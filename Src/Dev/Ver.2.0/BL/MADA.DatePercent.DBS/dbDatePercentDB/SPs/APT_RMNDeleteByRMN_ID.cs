...
{
public class procAPT_RMNDeleteByRMN_ID
{
public const string _Name = "APT_RMNDeleteByRMN_ID";
public const string _Caption = "APT_ RMNDelete By RMN_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_RMNDeleteByRMN_ID";
...
public const string _ParentName = "APT_RMNDeleteByRMN_ID";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_RMNDeleteByRMN_ID.DefaultView.[0].@RMN_ID";
