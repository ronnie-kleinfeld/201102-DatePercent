...
{
public class procAPT_USER_SETTINGSelectByUSS_USER_ID
{
public const string _Name = "APT_USER_SETTINGSelectByUSS_USER_ID";
public const string _Caption = "APT_ USER_ SETTINGSelect By USS_ USER_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_USER_SETTINGSelectByUSS_USER_ID";
...
public const string _ParentName = "APT_USER_SETTINGSelectByUSS_USER_ID";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_SETTINGSelectByUSS_USER_ID.DefaultView.[0].@USS_USER_ID";
...
public class rsAPT_USER_SETTINGSelectByUSS_USER_ID
{
public const string _Name = "APT_USER_SETTINGSelectByUSS_USER_ID";
public const string _Caption = "APT_ USER_ SETTINGSelect By USS_ USER_ ID";
public const string _ParentName = "APT_USER_SETTINGSelectByUSS_USER_ID";
...
public static void LoadDataSet(System.Data.DataSet p_ds, string p_strTableName,System.Nullable<int> p_iUSS_USER_ID)
{
try
{
...
public static void LoadDataSet(System.Data.DataSet p_ds, string p_strTableName,System.Nullable<int> p_iUSS_USER_ID,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_iUSS_USER_ID);
