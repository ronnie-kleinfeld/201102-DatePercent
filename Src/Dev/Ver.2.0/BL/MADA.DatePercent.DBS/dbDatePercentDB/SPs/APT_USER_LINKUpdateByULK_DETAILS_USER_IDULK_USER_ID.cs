...
{
public class procAPT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID
{
public const string _Name = "APT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID";
public const string _Caption = "APT_ USER_ LINKUpdate By ULK_ DETAILS_ USER_ IDULK_ USER_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID";
...
p_oSqlParameterCollection.Add(parULK_ID._SqlParameter(p_iULK_ID));
...
public const string _ParentName = "APT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID";
public const SqlDbType _SqlDbType = SqlDbType.DateTime;
public const Int32 _Length = 8;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID.DefaultView.[0].@ULK_DATE_TIME";
...
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID.DefaultView.[0].@ULK_DETAILS_USER_ID";
...
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID.DefaultView.[0].@ULK_ID";
public const string _BindDataReader = "[@ULK_ID]";
public const ParameterDirection _ParameterDirection = ParameterDirection.Input;
public static SqlParameter _SqlParameter()
{
return DBS.Tools.CreateSqlParameterReferenceType("@ULK_ID", 10, 0, 4, SqlDbType.Int, "int", ParameterDirection.Input, true, false, "");
}
public static SqlParameter _SqlParameter(System.Nullable<int> Value)
{
return DBS.Tools.CreateSqlParameterReferenceType("@ULK_ID", 10, 0, 4, SqlDbType.Int, "int", ParameterDirection.Input, true, false, "", Value);
}
}
...
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID.DefaultView.[0].@ULK_LINK_ACTION_TYPE";
...
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID.DefaultView.[0].@ULK_LINK_TYPE";
...
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_LINKUpdateByULK_DETAILS_USER_IDULK_USER_ID.DefaultView.[0].@ULK_USER_ID";
...
public class inULK_ID : parULK_ID {}
