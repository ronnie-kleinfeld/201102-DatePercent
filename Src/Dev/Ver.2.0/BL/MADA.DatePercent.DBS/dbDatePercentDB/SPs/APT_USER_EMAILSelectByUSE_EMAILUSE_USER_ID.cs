...
{
public class procAPT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID
{
public const string _Name = "APT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID";
public const string _Caption = "APT_ USER_ EMAILSelect By USE_ EMAILUSE_ USER_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID";
SqlParameterCollection(cmd.Parameters);
return cmd;
}
public static SqlCommand SqlCommand(
string p_strUSE_EMAIL, System.Nullable<int> p_iUSE_USER_ID)
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID";
SqlParameterCollection(cmd.Parameters, p_strUSE_EMAIL, p_iUSE_USER_ID);
return cmd;
}
...
public const string _ParentName = "APT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID";
public const SqlDbType _SqlDbType = SqlDbType.NVarChar;
public const Int32 _Length = 255;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID.DefaultView.[0].@USE_EMAIL";
...
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID.DefaultView.[0].@USE_USER_ID";
...
public class rsAPT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID
{
public const string _Name = "APT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID";
public const string _Caption = "APT_ USER_ EMAILSelect By USE_ EMAILUSE_ USER_ ID";
public const string _ParentName = "APT_USER_EMAILSelectByUSE_EMAILUSE_USER_ID";
...
public static void LoadDataSet(System.Data.DataSet p_ds, string p_strTableName,string p_strUSE_EMAIL, System.Nullable<int> p_iUSE_USER_ID)
{
try
{
Microsoft.Practices.EnterpriseLibrary.Data.Database db = DatabaseFactory.CreateDatabase();
SqlCommand cmd = SqlCommand(p_strUSE_EMAIL, p_iUSE_USER_ID);
...
public static void LoadDataSet(System.Data.DataSet p_ds, string p_strTableName,string p_strUSE_EMAIL, System.Nullable<int> p_iUSE_USER_ID,Microsoft.Practices.EnterpriseLibrary.Data.Database p_db,System.Data.Common.DbTransaction p_trn)
{
try
{
SqlCommand cmd = SqlCommand(p_strUSE_EMAIL, p_iUSE_USER_ID);
