...
{
public class procAPT_USER_SESSIONSelectByUSD_USER_ID
{
public const string _Name = "APT_USER_SESSIONSelectByUSD_USER_ID";
public const string _Caption = "APT_ USER_ SESSIONSelect By USD_ USER_ ID";

public static SqlCommand SqlCommand()
{
System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
cmd.CommandType = CommandType.StoredProcedure;
cmd.CommandText = "APT_USER_SESSIONSelectByUSD_USER_ID";
...
public const string _ParentName = "APT_USER_SESSIONSelectByUSD_USER_ID";
public const SqlDbType _SqlDbType = SqlDbType.Int;
public const Int32 _Length = 4;
public const bool _IsNullable = true;
public const string _BindDataAdapter = "APT_USER_SESSIONSelectByUSD_USER_ID.DefaultView.[0].@USD_USER_ID";
...
public class rsAPT_USER_SESSIONSelectByUSD_USER_ID
{
public const string _Name = "APT_USER_SESSIONSelectByUSD_USER_ID";
public const string _Caption = "APT_ USER_ SESSIONSelect By USD_ USER_ ID";
public const string _ParentName = "APT_USER_SESSIONSelectByUSD_USER_ID";
